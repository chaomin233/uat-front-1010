...
img_output="deepexi/cc"      # output image tag
...
sudo mv $proj_home/cc-provider/target/cc-*.jar $proj_home/cc-provider/target/demo.jar # 兼容所有sh脚本
